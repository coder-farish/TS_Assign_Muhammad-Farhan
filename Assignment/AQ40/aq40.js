...
function make_album(artist_name, album_title, album_tracks) {
    var music_album = { Artist: artist_name, Title: album_title, Tracks: album_tracks };
...
var dictionary1 = make_album("Atif Aslam", "Jal Pari");
var dictionary2 = make_album("Fuzon", "Saagar", 11); // Including number of tracks
var dictionary3 = make_album("Ali Haider", "Zalim Nazron Say", 15);
